...
uses
  ...
  buttons, fdac.dmdoc, datevk, DBGridEhVk, StdCtrls, Registry, DbGridColumnsParamList,
...
uses  Types, DocSqlManager, fdac.dmmain, fdac.fmCustomDoc,
      AppManager, fdac.docbinding;
{$R *.dfm}
