...
uses
  ...
  buttons, fib.dmdoc, datevk, DBGridEhVk, StdCtrls, Registry, DbGridColumnsParamList,
...
uses  Types, DocSqlManager, fib.dmmain, fib.fmCustomDoc,
      AppManager, fib.docbinding;
{$R *.dfm}
