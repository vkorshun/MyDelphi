...
uses
  ...
  dmAttributesOfGroup, vkvariable,fdac.dmDoc, {$IFDEF VER330}System.ImageList,{$ENDIF}
  EhLibVCL;
...
begin
  ...
  begin
    ...
    ifVarEmpty(MainDm.QueryValue('SELECT name FROM objects WHERE idobject=:idobject',
   [IdGroup]),'')]);
  end;
end;
