program RemoteEntranceServer;

uses
  SvcMgr,
  ServerMikkoEntrance in 'ServerMikkoEntrance.pas' {ServerMikkoEntrance1: TService},
...
begin
  ...
  Application.CreateForm(TServerMikkoEntrance1, ServerMikkoEntrance1);
