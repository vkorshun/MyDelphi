...
type
  ...
  protected
    ...
    function GetPessimisticUnLock: String; override;
...
{-------------------------------------------------------------------------------}
function TFDPhysADSCommandGenerator.GetPessimisticUnLock: String;
begin
//  Result := Result + 'SELECT ' + GetColumn('', -1, FTable.Columns[0]) +
//    ' FROM ' + GetFrom + ' WHERE ' + GetWhere(False, True, False);
//  FCommandKind := skSelectForUnLock;
