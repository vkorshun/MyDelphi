...
type
  ...
  TCallbackFunction = function(usPercent: Word; ulCallbackID: Longint): Longint;
  ...
  TProgressCallback = function(usPercent: Word): Longint;
    {$IFDEF WIN32} stdcall; {$ENDIF} {$IFDEF POSIX} cdecl; {$ENDIF}

  // This data type defines what type of function to pass to
  // AdsRegisterSQLAbortFunc().
  TSQLAbortFunc = function(): Longint;
    {$IFDEF WIN32} stdcall; {$ENDIF} {$IFDEF POSIX} cdecl; {$ENDIF}
